 ...
 */
ndarray_obj_t* getNumpyArray(const mp_obj_t arg, size_t len)
{
...
STATIC mp_obj_t adcsSoh_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args) {
	...
	self->moment = getNumpyArray(arg_vals[2].u_obj, 3);
...
MP_DEFINE_CONST_OBJ_TYPE(
		...
		MP_TYPE_FLAG_NONE,
		make_new, adcsSoh_make_new,
		locals_dict, &adcsSoh_locals_dict,
		print, adcsSoh_print,
		attr, adcsSoh_attr);
*/
...
MP_DEFINE_CONST_OBJ_TYPE(
		...
		MP_TYPE_FLAG_NONE,
		make_new, gpsSoh_make_new,
		locals_dict, &gpsSoh_locals_dict,
		print, gpsSoh_print,
		attr, gpsSoh_attr);
*/
...
MP_DEFINE_CONST_OBJ_TYPE(
		...
		MP_TYPE_FLAG_NONE,
		make_new, powerSoh_make_new,
		locals_dict, &powerSoh_locals_dict,
		print, powerSoh_print,
		attr, powerSoh_attr);
...
MP_DEFINE_CONST_OBJ_TYPE(
		...
		MP_TYPE_FLAG_NONE,
		make_new, tempSoh_make_new,
		locals_dict, &tempSoh_locals_dict,
		print, tempSoh_print,
		attr, tempSoh_attr);
*/
...
MP_DEFINE_CONST_OBJ_TYPE(
		...
		MP_TYPE_FLAG_NONE,
		make_new, comSoh_make_new,
		locals_dict, &comSoh_locals_dict,
		print, comSoh_print,
		attr, comSoh_attr);
*/
...
MP_REGISTER_MODULE(MP_QSTR_soh, soh_user_cmodule, 1);
