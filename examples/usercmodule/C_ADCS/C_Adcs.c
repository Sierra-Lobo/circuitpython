...
STATIC const mp_rom_map_elem_t cAdcs_globals_table[] = {
    { MP_OBJ_NEW_QSTR(MP_QSTR___name__), MP_OBJ_NEW_QSTR(MP_QSTR_cAdcs) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_cAdcs_driver), (mp_obj_t)&adcs_type },	
    { MP_OBJ_NEW_QSTR(MP_QSTR_single_iteration), MP_ROM_PTR(&adcs_single_iteration_obj) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_set_mode), MP_ROM_PTR(&adcs_set_mode_obj) },
};
...
MP_REGISTER_MODULE(MP_QSTR_c_adcs, cAdcs_user_cmodule, 1/*MODULE_PROPERTYCLASS_ENABLED*/);
